...
//             let pContent = document.createTextNode("Congatulation you won this Level... Try in more advanced level");
...
//     if (document.querySelector(".winning")) {
//         document.querySelector(".winning").remove()
//     }
//     inputField.value = "";
